...
def load_users(apps, schema_editor):
    ...
    user = User(id=1,password='pbkdf2_sha256$24000$mslWsXmPzCy1$GzTLr/BJFm/sTRNCdgJJZ9RM6Z6UJkV75JVmKqPExy0=',last_login='Never',is_superuser=False,username='demo', first_name='demo',last_name='user',email='none@none.com',is_staff=False,is_active=True,date_joined=None,name='demo')
    user.save()
